...
//        });
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                Api.myRating+"/"+ MyPrefrences.getUserID(getActivity()), null, new Response.Listener<JSONObject>() {
...
//                    String name = response.getString("name");
                    ...
                    if (response.getString("status").equalsIgnoreCase("success")){
                        ...
                        for (int i=0;i<jsonArray.length();i++){
                            ...
                            map.put("bussiness_id",jsonObject.optString("bussiness_id"));
                            map.put("rating_user_id",jsonObject.optString("rating_user_id"));
                            map.put("business_name",jsonObject.optString("business_name"));
...
//            }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
           ...
           // viewholder.uname=convertView.findViewById(R.id.uname);
            ...
            viewholder.comName.setText(AllProducts.get(position).get("business_name"));
...
//                                            Toast.makeText(getActivity(), jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            viewholder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bundle.putString("business_name", AllProducts.get(position).get("business_name"));
                    bundle.putString("review", AllProducts.get(position).get("review"));
                    bundle.putString("rating_score", AllProducts.get(position).get("rating"));
                    bundle.putString("bussiness_id", AllProducts.get(position).get("bussiness_id"));
                    bundle.putString("rating_user_id", AllProducts.get(position).get("rating_user_id"));
                    FragmentManager manager=getActivity().getSupportFragmentManager();
                    FragmentTransaction ft=manager.beginTransaction();
                    fragment.setArguments(bundle);
                    ft.replace(R.id.content_frame,fragment).addToBackStack(null).commit();
